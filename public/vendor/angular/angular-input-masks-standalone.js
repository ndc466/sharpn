 ...
 */
var phoneMask8D = {
		areaCode: new StringMask('(000) 000-0000'), 	//with area code
		simple: new StringMask('(000) 000-0000') 			//without area code
	}, phoneMask9D = {
		areaCode: new StringMask('(000) 000-0000'), 	//with area code
		simple: new StringMask('(000) 000-0000') 			//without area code
	}, phoneMask0800 = {
		areaCode: null,									//N/A
		simple: new StringMask('(000) 000-0000') 		//N/A, so it's "simple"
	};
